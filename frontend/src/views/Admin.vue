    ...
    <div class="row w-100 overflow-hidden">
        <div v-if="$route.name != 'AdminLogin'" class="col-3 d-flex flex-column flex-shrink-0 p-3 bg-light shadow" style="height: 100vh">            
            ...
            <ul class="nav nav-pills flex-column">
                <li class="nav-item">
                    <router-link :to="{name:'AdminDashboard'}" class="nav-link" :class="$route.name == 'AdminDashboard' ? 'active' : 'link-dark'" aria-current="page">
                ...
                <li>
                    <router-link :to="{name:'AdminAccount'}" class="nav-link" :class="$route.name == 'AdminAccount' ? 'active' : 'link-dark'">
                ...
                <li>
                    <router-link :to="{name:'AdminDisaster'}" class="nav-link" :class="$route.name == 'AdminDisaster' ? 'active' : 'link-dark'">
                ...
                <li>
                    <router-link :to="{name:'AdminUser'}" class="nav-link" :class="$route.name == 'AdminUser' ? 'active' : 'link-dark'">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-circle me-2" viewBox="0 0 16 16">
                        <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0z"/>
                        <path fill-rule="evenodd" d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8zm8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 10s4.757 1.225 5.468 2.37A7 7 0 0 0 8 1z"/>
                    </svg>
                ...
                <li>
                    <router-link :to="{name:'AdminCategory'}" class="nav-link" :class="$route.name == 'AdminCategory' ? 'active' : 'link-dark'">
                ...
                <li>
                    <router-link :to="{ name:'AdminProducts' }" class="nav-link" :class="$route.name == 'AdminProducts' ? 'active' : 'link-dark'">
                ...
                <li>
                    <button class="nav-link link-dark" data-bs-toggle="collapse" data-bs-target="#report-collapse">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-files me-2" viewBox="0 0 16 16">
                    ...
                    <div class="collapse" id="report-collapse">
                        <ul class="list-unstyled">
                            <li>
                                <router-link :to="{ name: 'ReportDisaster' }" class="nav-link" style="margin-left: 35px" :class="$route.name == 'ReportDisaster' ? 'active' : 'link-dark'">Laporan Bencana</router-link>
                            </li>
                            <li>
                                <router-link :to="{ name: 'ReportProduct' }" class="nav-link" style="margin-left: 35px" :class="$route.name == 'ReportProduct' ? 'active' : 'link-dark'">Laporan Barang</router-link>
                            </li>
                        </ul>
                    </div>
                </li>
